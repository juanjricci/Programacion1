...
const AddProducts = () => {
    ...
    const getDistribuidor = async () => {
        const res = await axios.get(`${URL_PRODUCTOS}/api/distribuidores-activos/?estado=true`, {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        console.log(data)
        axios.post(`${URL_PRODUCTOS}/api/productos/`, data, {
            headers: {
                'Content-Type': 'application/json',
            },
        }).then((res) => {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <select className="form-control" id="exampleFormControlSelect1" onChange={(e) => {
                            setIdDist(e.target.value.charAt(0))
                        }} >
